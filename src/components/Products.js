...
import { Title, ProductsContainer, ProductsListContainer, ProductDetailContainerError, ProductItem, ProductsList } from '../styles/styles';
...
class Products extends Component {
    ...
    render() {
        const listProducts = this.props.products.length ? (
            <ProductsList>
                <Filter />
                <ProductsListContainer className="ProductsList">
                {
        ...
        return (            
            <ProductsContainer className="Content">
                {listProducts}                
            </ProductsContainer>
